...
export const PieChart = ({ title, description, data, series, date, emptyState, errorState, error = false, loading = false, tooltip = true, origo = { x: 50, y: 50 }, legend: legendProp = {}, border = "neutral-alpha-weak", variant: variantProp, ring = { inner: 0, outer: 80 }, dataKey = "value", nameKey = "name", "data-viz-style": dataViz, ...flex }) => {
