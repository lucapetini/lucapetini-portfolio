...
export const KbarContent = ({ isOpen, onClose, items, placeholder = "Search", }) => {
    ...
    return (_jsx(Row, { position: "fixed", top: "0", left: "0", right: "0", bottom: "0", zIndex: 10, center: true, background: "overlay", className: `${styles.overlay} ${isClosing ? styles.closing : ""}`, onClick: (e) => {
