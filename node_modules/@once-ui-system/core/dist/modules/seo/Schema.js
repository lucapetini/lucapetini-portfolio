...
export function Schema({ as, title, description, baseURL, path, datePublished, dateModified, image, sameAs = [], author, }) {
    ...
    return (_jsx(Script, { id: `schema-${as}-${path}`, type: "application/ld+json", 
