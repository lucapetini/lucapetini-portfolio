...
export const useArrowNavigation = ({ layout, itemCount, columns = 8, containerRef, onSelect, onFocusChange, wrap = true, initialFocusedIndex = -1, itemSelector = '[role="option"], [data-value], button, [tabindex]:not([tabindex="-1"])', autoFocus = false, disabled = false, disableHighlighting = false, }) => {
