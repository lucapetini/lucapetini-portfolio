...
export const useResponsiveClasses = (elementRef, responsiveProps, currentBreakpoint) => {
    if (!elementRef) {
        return;
    }
    const appliedClasses = useRef(new Set());
    const originalClasses = useRef([]);
            ...
            if (value !== undefined) {
                ...
                switch (property) {
                    ...
                    case "vertical":
                        ...
                        const isVerticalRowDirection = !verticalDirection ||
