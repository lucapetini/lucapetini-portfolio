...
const Input = forwardRef(({ id, label, placeholder, height = "m", error = false, errorMessage, description, radius, className, style, hasPrefix, hasSuffix, characterCount, children, onFocus, onBlur, validate, cursor, ...props }, ref) => {
    ...
    const inputClassNames = classNames(styles.input, "font-body", "font-default", "font-m", cursor === "interactive" ? "cursor-interactive" : undefined, {
    ...
    return (_jsxs(Column, { gap: "8", style: style, fillWidth: true, fitHeight: true, className: classNames(className, {
        ...
        }), children: [_jsxs(Row, { transition: "micro-medium", border: "neutral-medium", background: "neutral-alpha-weak", overflow: "hidden", vertical: "stretch", className: classNames(styles.base, {
                    [styles.s]: height === "s",
                }, {
                    [styles.m]: height === "m",
