...
import { Flex } from ".";
const MatrixFx = React.forwardRef(({ speed = 1, colors = ["brand-solid-medium"], size = 3, spacing = 3, revealFrom = "center", trigger = "instant", active = false, flicker = false, bulge, fps = 60, children, ...rest }, forwardedRef) => {
