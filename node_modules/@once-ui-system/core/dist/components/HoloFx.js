...
const HoloFx = ({ children, shine, burn, texture, ...rest }) => {
    ...
    return (_jsxs(Flex, { overflow: "hidden", className: styles.holoFx, ref: ref, ...rest, children: [_jsx(Flex, { fill: true, className: styles.base, children: children }), _jsx(Flex, { m: { hide: true }, position: "absolute", fill: true, pointerEvents: "none", className: classNames(styles.overlay, styles.burn), style: {
                    ["--burn-opacity"]: burnDefaults.opacity + "%",
                    filter: burnDefaults.filter,
                    mixBlendMode: burnDefaults.blending,
                    maskImage: burnDefaults.mask,
                }, children: children }), _jsx(Flex, { m: { hide: true }, position: "absolute", fill: true, pointerEvents: "none", className: classNames(styles.overlay, styles.shine), style: {
                ...
                }, children: children }), _jsx(Flex, { m: { hide: true }, position: "absolute", fill: true, pointerEvents: "none", className: classNames(styles.overlay, styles.texture), style: {
