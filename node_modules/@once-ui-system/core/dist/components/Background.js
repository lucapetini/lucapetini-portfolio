...
const Background = forwardRef(({ gradient = {}, dots = {}, grid = {}, lines = {}, mask, children, className, style, ...rest }, forwardedRef) => {
    ...
    const renderContent = () => (_jsxs(_Fragment, { children: [gradient.display && (_jsx(Flex, { position: "absolute", className: styles.gradient, opacity: gradient.opacity, pointerEvents: "none", style: {
                ...
                } })), dots.display && (_jsx(Flex, { position: "absolute", top: "0", left: "0", fill: true, pointerEvents: "none", className: styles.dots, opacity: dots.opacity, style: {
                ...
                return (_jsx(Flex, { position: "absolute", top: "0", left: "0", fill: true, pointerEvents: "none", className: styles.lines, opacity: lines.opacity, style: {
            ...
            })(), grid.display && (_jsx(Flex, { position: "absolute", top: "0", left: "0", fill: true, pointerEvents: "none", opacity: grid.opacity, style: {
    ...
    return (_jsx(Flex, { ref: backgroundRef, fill: true, className: classNames(className), zIndex: 0, overflow: "hidden", style: style, ...rest, children: mask ? (_jsx(Mask, { fill: true, position: "absolute", cursor: mask.cursor, radius: mask.radius, x: mask.x, y: mask.y, children: renderContent() })) : (renderContent()) }));
});
