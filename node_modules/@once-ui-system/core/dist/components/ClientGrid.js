...
const ClientGrid = forwardRef(({ cursor, hide, xl, l, m, s, xs, ...props }, ref) => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(ServerGrid, { ...props, xl: xl, l: l, m: m, s: s, xs: xs, isDefaultBreakpoints: isDefaultBreakpoints(), hide: hide, ref: combinedRef, style: {
                    ...props.style,
