...
const LogoCloud = forwardRef(({ logos, className, style, limit = 6, rotationInterval = ANIMATION_DURATION, ...rest }, ref) => {
    const [visibleLogos, setVisibleLogos] = useState(() => logos.slice(0, limit));
    ...
    return (_jsx(Grid, { ref: ref, className: classNames(styles.container, className), style: style, ...rest, children: visibleLogos.map((logo, index) => (_jsx(Flex, { vertical: "center", horizontal: "center", paddingX: "24", paddingY: "20", radius: "l", children: _jsx(Logo, { className: shouldRotate ? styles.logo : styles.staticLogo, style: {
                    ...logo.style,
