...
const FlipFx = forwardRef((props, ref) => {
    ...
    return (_jsxs(Flex, { ref: (node) => {
            ...
            perspective: "1000px",
            ...style,
        }, onClick: handleFlip, onKeyDown: handleKeyDown, role: "button", "aria-pressed": flippedState, tabIndex: 0, ...flex, children: [_jsx(Flex, { ref: frontRef, fill: true, position: "absolute", overflow: "hidden", "aria-hidden": flippedState, style: {
                    backfaceVisibility: "hidden",
                }, children: front }), _jsx(Flex, { ref: backRef, fill: true, position: "absolute", overflow: "hidden", "aria-hidden": !flippedState, style: {
                    backfaceVisibility: "hidden",
                    transform: "rotateY(180deg)",
                }, children: _jsx(Flex, { fill: true, style: {
