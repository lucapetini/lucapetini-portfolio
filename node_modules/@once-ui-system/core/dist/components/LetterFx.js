...
const LetterFx = forwardRef(({ children, trigger = "hover", speed = "medium", charset = defaultCharset, onTrigger, className, style, }, ref) => {
    ...
    return (_jsx("span", { ref: ref, className: classNames(className), style: style, onMouseOver: trigger === "hover" ? eventHandler : undefined, children: text }));
});
